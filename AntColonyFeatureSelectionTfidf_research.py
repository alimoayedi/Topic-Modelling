...
dataset_df = pd.read_csv(r'dataset/research/Train.csv', delimiter=',')
# test_dataset_df = pd.read_csv(dataset_path + '/Test.csv', delimiter=',')

dataset_df = dataset_df.set_index('id')
# test_dataset_df = test_dataset_df.set_index('id')
...
documents_df = dataset_df[['ABSTRACT']]
# test_documents_df = testdataset_df[['ABSTRACT']]

# create a dataframe for labels
labels_df = dataset_df[favorite_topics]
# test_labels_df = test_dataset_df[favorite_topics]
...
if sample_keys is not None:
    ...
    sample_keys = ut.get_sample_equal_size(0.2, favorite_topics_id, fav_documents_topics)
